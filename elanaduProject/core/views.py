...
def user_cart_page(request):
    ...
    total_price = sum(i.product.price for i in cart_items)
    context = {
    ...
    if request.method == 'POST':
        ...
        for item in cart_items:
            Order.objects.create(
                ...
                total_amount=item.product.price,  # Assuming total_amount is the product price
